...
namespace Cupcakes.Migrations
{
    ...
    [Migration("20200216055034_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cupcakes.Models.Cupcake", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { CupcakeId = 3, BakeryId = 3, CupcakeType = 3, Description = "Chocolate cupcake with strawberry cream filling", GlutenFree = false, ImageMimeType = "image/jpeg", ImageName = "pink-cupcake.jpg", Price = 4.0 },
            ...
            modelBuilder.Entity("Cupcakes.Models.Cupcake", b =>
                {
                    b.HasOne("Cupcakes.Models.Bakery")
                        .WithMany("Cupcakes")
